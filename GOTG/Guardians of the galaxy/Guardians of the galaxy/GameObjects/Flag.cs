...
namespace Guardians_of_the_galaxy.GameObjects
{
    class Flag : sprite
    {
        ...
        {
            spriteBatch.Draw(_flagTexture, this.Position, new Rectangle(0,0,_flagTexture.Width,_flagTexture.Height), Color.White, 0, new Vector2(0, 0), 1f, SpriteEffects.None, 0);
        }
